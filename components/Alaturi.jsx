...
export default function Alaturi() {
  return (
    <section className="bg-alaturi relative flex h-[30rem] w-full items-center justify-center bg-cover max-md:bg-center bg-no-repeat bg-fixed bg-center md:h-[30rem]">
